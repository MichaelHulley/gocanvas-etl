# =========================================
# GoCanvas Drum Rework / Reruns ETL Script
# Author: Michael Hulley
# Date: 2026-05-13
# Description:
#   Extracts GoCanvas submissions and responses
#   for drum rework / rerun forms.
#
#   These forms capture drums removed from stock
#   and added back into production as physical paste kg.
#
#   Brix-equivalent conversion is calculated later
#   in reporting, not in this ETL.
# =========================================
...
PROCESS_AREA = "DrumRework"
ETL_PROCESS_NAME = "gc_reruns_etl.py"

FALLBACK_FORM_IDS = [
    5830405,  # Rec 046 Rework Check Sheet - new
    5835147,  # ReworkCheckSheet - published
]
...
def main() -> None:
    ...
    if not form_ids:
        ...
        print(f"Using fallback rework form IDs: {FALLBACK_FORM_IDS}")
        form_ids = FALLBACK_FORM_IDS
