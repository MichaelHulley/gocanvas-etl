...
#   for all active Intake forms assigned to this ETL process
#   in dbo.gocanvas_form_registry, and loads RAW data into:
#       dbo.stg_gocanvas_submission
#       dbo.stg_gocanvas_response
#
#   Notes:
#   - Uses registry-driven form selection
#   - Uses process watermark from dbo.etl_process_control
#   - Uses exact form_id filtering after API fetch
#   - Uses MERGE for submission and response staging loads
#   - Uses early-stop paging after matching pages have been found
# =========================================
...
def print_row_length_warnings(response_rows: list[tuple]) -> None:
